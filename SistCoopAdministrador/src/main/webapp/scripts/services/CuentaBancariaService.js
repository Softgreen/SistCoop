      ...
      return {
        getCuentasBancariasView: function (tipoCuentaList, tipoPersonaList, estadoCuentaList, offset, limit) {
          if (arguments.length == 0) {
            ...
            return Restangular.all(baseUrl).getList({
              "tipoCuenta": tipoCuentaList,
              "tipoPersona": tipoPersonaList,
              "tipoEstadoCuenta": estadoCuentaList
            }, {});
        ...
        anularChequera: function (idCuentaBancaria, idChequera) {
          return Restangular.all(baseUrl + "/" + idCuentaBancaria + "/chequeras/" + idChequera + "/desactivar").post();
        },
