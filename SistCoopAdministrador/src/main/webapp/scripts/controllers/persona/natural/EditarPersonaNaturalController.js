define(['../../module'], function (controllers) {
    'use strict';
    controllers.controller('EditarPersonaNaturalController', ['$scope', '$state','$stateParams','$window','$timeout','focus','MaestroService', 'PersonaNaturalService',
        function($scope,$state,$stateParams,$window,$timeout,focus,MaestroService,PersonaNaturalService) {
