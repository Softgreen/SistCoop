define(['../../module'], function (controllers) {
    'use strict';
    controllers.controller('BuscarPersonaJuridicaController', ['$scope','$state','$location','$window','ngProgress','focus','PersonaJuridicaService',
        function($scope, $state,$location,$window,ngProgress,focus,PersonaJuridicaService){
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    {field:"fechaConstitucion", displayName:'F. CONSTITUCION', cellFilter: "date:'dd/MM/yyyy'", width:120},
