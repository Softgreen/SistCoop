...
public class BovedaRESTService implements BovedaREST {
	...
	public Response getDetalleTransaccionBovedaCaja(BigInteger idTransaccionBovedaCaja) {
		List<GenericDetalle> transBovedaCajaDetalle = transaccionInternaServiceNT.getDetalleTransaccionBovedaCaja(idTransaccionBovedaCaja);
		return Response.status(Response.Status.OK).entity(transBovedaCajaDetalle).build();
	}
