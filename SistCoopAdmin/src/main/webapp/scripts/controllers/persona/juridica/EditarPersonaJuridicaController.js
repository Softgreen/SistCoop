define(['../../module'], function (controllers) {
    'use strict';
    controllers.controller('EditarPersonaJuridicaController', ["$scope", "$state","$location", "$window","$timeout","focus","MaestroService", "PersonaNaturalService", "PersonaJuridicaService",
        function($scope, $state,$location, $window,$timeout,focus,MaestroService, PersonaNaturalService, PersonaJuridicaService) {
