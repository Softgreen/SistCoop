define(['../../module'], function (controllers) {
    ...
    controllers.controller('AccionistaController', [ "$scope","$state","$location", "$window", "$timeout", "$filter","focus","MaestroService", "PersonaNaturalService",
        function($scope,$state,$location,$window,$timeout,$filter,focus,MaestroService, PersonaNaturalService) {
