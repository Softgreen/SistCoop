define(['../../module'], function (controllers) {
    'use strict';
    controllers.controller('BuscarPersonaNaturalController', ['$scope','$state','$timeout','$location','$window','ngProgress','focus','PersonaNaturalService',
        function($scope,$state,$timeout,$location,$window,ngProgress,focus,PersonaNaturalService){
