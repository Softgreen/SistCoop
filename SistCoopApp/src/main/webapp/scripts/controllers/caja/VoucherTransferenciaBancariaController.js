  ...
  controllers.controller('VoucherTransferenciaBancariaController', ["$scope", "$state", "$filter", "CajaService", "RedirectService",
    function ($scope, $state, $filter, CajaService, RedirectService) {
      ...
      $scope.imprimir = function () {
        ...
        qz.append("CUENTA ORIGEN:" + "\t" + ($scope.transferenciaCuentaBancaria.numeroCuentaOrigen) + "\r\n");
        qz.append("CUENTA DESTINO:" + "\t" + ($scope.transferenciaCuentaBancaria.numeroCuentaDestino) + "\r\n");
        qz.append("CLIENTE:" + "\t" + ($scope.transferenciaCuentaBancaria.socio) + "\r\n");
        ...
        if (($scope.transferenciaCuentaBancaria.tipoTransaccion) == "DEPOSITO") {
          qz.append("\r\n");
