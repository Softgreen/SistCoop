define(['./app'], function (app) {
  ...
  return app.config(['$httpProvider', '$stateProvider', '$urlRouterProvider', 'RestangularProvider', 'localStorageServiceProvider',
    function ($httpProvider, $stateProvider, $urlRouterProvider, RestangularProvider, localStorageServiceProvider) {
      ...
      RestangularProvider.setBaseUrl('http://multivadelsur.ddns.net:8080/SistCoopREST/rest');
      ...
      $stateProvider
              ...
              controller: function ($scope) {
                $scope.menus = [
                   ...
                   ]},*/
                  {
                    ...
                    {'name': 'Sobre giros', 'state': 'app.transaccion.buscarSobreGiros'}
                  ]
                  },
                  {
        ...
        .state('app.socio', {
          ...
          views: {
            ...
            "viewContent": {
              ...
              "<table style='width: 930px;'> <tr style='text-align: center; color: red; font-size: 16px;'><td><strong>Cuenta Libre</strong></td> <td></td> <td><strong>Cuenta Plazo Fijo</strong></td> <td></td> <td><strong>Cuenta Recaudadora</strong></td></tr>" +
              "<tr><td style='width: 290px; text-align: justify;'>Te pagamos intereses mensuales y los mejores del mercado. <ul type=square><li>No cobramos portes ni mantenimiento de cuentas.</li><li>Te ofrecemos las mejores tasas de interés del mercado.</li><li>Son de libre disponibilidad.</li><li>No cobramos ITF (Impuesto a las Transacciones Financieras).</li><li>Depósitos y retiros en cualquiera de nuestras agencias.</li></ul></td>" +
              "<td style='width: 30px;'></td>" +
              "<td style='width: 290px; text-align: justify;'>Tu dinero no es de libre disponibilidad hasta cumplir con el plazo del contrato. </br>Para ahorrar a plazo fijo necesitas ser cliente de Multivalores del Sur y contar con lo siguiente:<ul type=square><li>Copia de tu D.N.I.</li><li>Monto mínimo de apertura S/.500.- n.s., o $.200.- dólares americanos.</li><li>Tiempo mínimo: 03 meses.</li><li>Puedes renovar automáticamente al culminar el plazo elegido y sigues ganando más intereses.</li></ul></td>" +
              "<td style='width: 30px;'></td>" +
              "<td style='width: 290px; text-align: justify;'>El dinero de la cuenta recaudadora puede ser girado posteriormente a través de cheques, o bien puede sacarlo mediante un cajero automático y también hacer pagos mediante una tarjeta de débito, pagos automáticos de cuentas de servicios o pagar o girar dinero hacia otras cuentas a través del sitio web de Multivalores del Sur.</td></tr> </table>" +
        ...
        .state('app.transaccion.crearGiro', {
          ...
          views: {
            "viewContent": {
              templateUrl: "views/cajero/transaccion/crearGiro.html"
            }
          }
        })
        .state('app.transaccion.editarGiro', {
          url: "/editarGiro/:id",
          views: {
            "viewContent": {
              templateUrl: "views/cajero/transaccion/editarGiro.html",
              controller: function ($scope, $stateParams) {
                $scope.id = $stateParams.id;
              }
            }
        ...
        .state('app.transaccion.buscarSobreGiros', {
          url: "/buscarSobreGiros",
          views: {
            "viewContent": {
              templateUrl: "views/cajero/transaccion/buscarSobreGiros.html"
            }
          }
        })
        .state('app.transaccion.crearSobreGiro', {
          url: "/crearSobreGiro",
          views: {
            "viewContent": {
              templateUrl: "views/cajero/transaccion/crearSobreGiro.html"
            }
          }
        })
