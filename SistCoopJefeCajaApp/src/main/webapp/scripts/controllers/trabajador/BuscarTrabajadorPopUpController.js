define(['../module'], function (controllers) {
    'use strict';
    controllers.controller('BuscarTrabajadorPopUpController', ['$scope','$timeout','$modalInstance','focus','TrabajadorService',
        function($scope,$timeout,$modalInstance,focus,TrabajadorService) {
            ...
            $scope.getPagedDataInitial = function () {
                ...
                TrabajadorService.getSocios(false, true, $scope.getDesde(), $scope.getHasta()).then(function(data){
                    $scope.sociosList = data;
