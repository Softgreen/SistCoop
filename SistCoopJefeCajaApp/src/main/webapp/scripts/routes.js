        ...
        function($httpProvider, $stateProvider, $urlRouterProvider, RestangularProvider, localStorageServiceProvider) {
            ...
            $stateProvider
                .state('home', {
                    url: '/home?redirect',
                    template: '' +
                        '</br><div class="center-block"><h2 class="text-center" style="font-weight: bold; color: blue;">Sistema Financiero</h2></div></br>' +
                ...
                .state('app.boveda', {
                    ...
                    views: {
                        ...
                        "viewContent":{
                        	template: '<div ui-view style="min-height: 472px;"><h4 class="text-center" style="font-weight: bold; color: blue;">ADMINISTRAR BOVEDA</h4><h3 class="text-center"><img alt="Caja Ventura" src="images/modules/boveda.png"></h3></div>'
                        }
                    }
                })
                .state('app.caja', {
                    ...
                    views: {
                        ...
                        "viewContent":{
                        	template: '<div ui-view style="min-height: 472px;"><h4 class="text-center" style="font-weight: bold; color: blue;">ADMINISTRAR CAJA</h4><h3 class="text-center"><img alt="Caja Ventura" src="images/modules/caja.gif"></h3></div>'
                        }
                    }
                })
                .state('app.transaccion', {
                    ...
                    views: {
                        ...
                        "viewContent":{
                        	template: '<div ui-view style="min-height: 472px;"><h4 class="text-center" style="font-weight: bold; color: blue;">TRANSACCION BOVEDA</h4><h3 class="text-center"><img alt="Caja Ventura" src="images/modules/transacciones.png"></h3></div>'
                        }
                    }
                })
